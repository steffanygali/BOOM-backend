...
INSTALLED_APPS = [
    ...
    'drf_spectacular',                #para generar la documentacion
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:4200', # puerto donde se correra el front
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'boom_api.models.BearerTokenAuthentication',
    ),
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/day',
        'user': '1000/day', # Límite sano de peticiones por usuario al día
    }
}
